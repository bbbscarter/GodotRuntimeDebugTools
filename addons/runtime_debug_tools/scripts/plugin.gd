...
func _enter_tree():
    ...
    if not ProjectSettings.has_setting("autoload/RemoteInspector"):
        add_autoload_singleton("RemoteInspector", _runtime_scene)
...
func _exit_tree():
    ...
    if ProjectSettings.has_setting("autoload/RemoteInspector"):
        remove_autoload_singleton("RemoteInspector")
